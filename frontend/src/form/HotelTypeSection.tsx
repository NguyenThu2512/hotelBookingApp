...
const HotelTypeSection = () => {
  ...
  return (
    <div>
        ...
        {
            hotelTypes.map((type)=>(
                <label className={typeWatch===type?"cursor-pointer bg-blue-300 text-sm rounded-full px-4 py-3 font-semibold":
                                    "cursor-pointer bg-gray-300 text-sm rounded-full px-4 py-3 font-semibold"}>
